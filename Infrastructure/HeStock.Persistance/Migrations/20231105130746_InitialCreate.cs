...
namespace HeStock.Persistance.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleEndpoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleEndpoints_AspNetRoles_AppRoleId",
                        column: x => x.AppRoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleEndpoints_Endpoints_EndpointId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleEndpoints_AppRoleId",
                table: "RoleEndpoints",
                column: "AppRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleEndpoints_EndpointId",
                table: "RoleEndpoints",
                column: "EndpointId");
        }
